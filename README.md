...
function SendNotification(text)
    Notification:Notify(
        {Title = "Vamp.gg V1", Description = "By Vamp.gg (Lyrical) - "..text},
        {OutlineColor = Color3.fromRGB(255,165,0),Time = 3, Type = "image"},
        {Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255,165,0)}
    )
end
...
--// Change Prediction,  AutoPrediction Must Be Off
    ...
    spawn(function()
        ...
        makemarker(placemarker, placemarker, Color3.fromRGB(255,165,0), 1, 0)
        end
    end)
...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255,165,0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(155,40,0))}
...
do
	local Window = library:AddWindow("Vamp.gg V1", {
...
local AntiFolder = Tib:AddFolder("Anti Lock")
		AntiFolder:AddLabel("WILL SOON WILL BE ADDING TO VAMP.GG")
